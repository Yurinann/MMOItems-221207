...
public class UpgradeItemEvent extends PlayerDataEvent {
     ...
     *
     * @param playerData     Player upgrading the item
     * @param consumable     Consumable used to upgrade the item
     * @param target         Item being upgraded
     * @param consumableData Upgrade info about the consumable
     * @param targetData     Upgrade info about the target item
     */
