...
public enum ParticleType {
    ...
    /**
     * @param func      What the effect does
     * @param override  Higher priority particle effect which disables every other
     *                  effects
     * @param period    The particle displays again every X seconds
     * @param lore      The effect description
     * @param modifiers The list of double modifeirs that allow to configurate the
